...
namespace Flock.Leaderboard
{
    public class FlockLeaderboardProvider : ILeaderboardProvider
    {
        ...
        public FlockLeaderboardProvider(FlockClient client)
        {
            ...
            _baseUrl = $"{_apiUrl}/leaderboards";
        }

        /// <summary>
        /// Gets all leaderboards for the current game
        /// </summary>
        public async Task<List<LeaderboardInfo>> GetAllLeaderboardsAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                _client.Logger.LogWarning("Get all leaderboards operation was cancelled");
                throw;
            }
        ...
        /// <summary>
        /// Gets a specific leaderboard by ID
        /// </summary>
        public async Task<LeaderboardInfo> GetLeaderboardByIdAsync(string leaderboardId, CancellationToken cancellationToken = default)
        {
            ...
            {
                _client.Logger.LogWarning($"Get leaderboard {leaderboardId} operation was cancelled");
                throw;
            }
            catch (FlockException)
            {
        ...
        /// <summary>
        /// Gets leaderboard entries with pagination
        /// </summary>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                _client.Logger.LogWarning($"Get leaderboard entries for {leaderboardId} operation was cancelled");
                throw;
            }
            catch (FlockException)
            {
        ...
        /// <summary>
        /// Gets top entries from a leaderboard
        /// </summary>
        public async Task<List<LeaderboardEntry>> GetTopEntriesAsync(string leaderboardId, int count = 10, CancellationToken cancellationToken = default)
        {
            ...
            {
                _client.Logger.LogWarning($"Get top entries for {leaderboardId} operation was cancelled");
                throw;
            }
            catch (FlockException)
            {
        ...
        /// <summary>
        /// Gets a player's entry in a leaderboard
        /// </summary>
        public async Task<LeaderboardEntry> GetPlayerEntryAsync(string leaderboardId, string playerId, CancellationToken cancellationToken = default)
        {
            ...
            {
                _client.Logger.LogWarning($"Get player entry for {playerId} operation was cancelled");
                throw;
            }
            catch (FlockException)
            {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                _client.Logger.LogWarning($"Submit score for player {playerId} operation was cancelled");
                throw;
            }
            catch (FlockException)
            {
        ...
        /// <summary>
        /// Gets entries around a specific player's rank
        /// </summary>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                _client.Logger.LogWarning($"Get entries around player {playerId} operation was cancelled");
                throw;
            }
            catch (FlockException)
            {
